...
<Tabs items={['npx', 'npm', 'yarn', 'pnpm', 'bun']}>
  <Tab>```bash copy npx create-mastra@latest ```</Tab>
  <Tab>```bash copy npm create mastra@latest ```</Tab>
  <Tab>```bash copy yarn create mastra@latest ```</Tab>
  <Tab>```bash copy pnpm create mastra@latest ```</Tab>
  <Tab>```bash copy bun create mastra@latest ```</Tab>
</Tabs>
