  ...
  content={[
    {
      name: 'getAgent(name)',
      type: 'Agent',
      description: 'Returns an agent instance by id. Throws if agent not found.',
    ...
    },
    {
      name: 'getVector(name)',
      type: 'MastraVector',
      description: 'Returns a vector store instance by name. Throws if not found.',
      example: 'const vectorStore = mastra.getVector("myVectorStore");',
    },
    {
      name: 'getVectors()',
      type: 'Record<string, MastraVector>',
      description: 'Returns all registered vector stores as a key-value object.',
    ...
    },
    {
      ...
      type: 'void',
      description: 'Sets the logger for all components (agents, workflows, etc.).',
      example: 'mastra.setLogger({ logger: new PinoLogger({ name: "MyLogger" }) });',
    },
    {
